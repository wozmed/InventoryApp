					...
					<form method="post" action="" name="edit-user" data-id="<?php echo $userd->id; ?>">
						...
						<div class="select-holder">
							...
							<select name="euser-role">
								<option value="1"<?php if($userd->role == 1) echo ' selected'; ?>>Administrator</option>
								...
								<option value="4"<?php if($userd->role == 4) echo ' selected'; ?>>Employee</option>
							</select>
						</div>
						<input type="submit" name="euser-submit" class="ni btn blue" value="Edit user" />
					</form>
				</div>
			</div>
		</div>
