			...
			<div class="center">
				<div class="form">
					<form method="post" action="" name="invento-settings">
						<div class="checkbox"><input type="checkbox" name="allow-namechange" value="y" <?php if($sitedata[0] == 'y') echo 'checked'; ?>/>Allow users to change their name<br /></div>
						<div class="checkbox"><input type="checkbox" name="allow-emailchange" value="y" <?php if($sitedata[1] == 'y') echo 'checked'; ?>/>Allow users to change their email<br /></div>
						<br />
