			...
			<div class="center">
				<div class="form">
					<form method="post" action="" name="edit-cat" data-id="<?php echo $cat->id; ?>">
						...
						<span class="ncat-desc-left">Category Description (<?php echo 400-strlen($cat->descrp); ?> characters left):</span><br />
						<div class="ni-cont">
							<textarea name="ncat-descrp" class="ni"><?php echo $cat->descrp; ?></textarea>
						</div>
						<input type="submit" name="ncat-submit" class="ni btn blue" value="Save category" />
					</form>
				</div>
			</div>
		</div>
